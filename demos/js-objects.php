...
<section class="<?php echo $custom_class; ?> mt-4">
    <article>
        ...
        <div id="display-info" class="">
            <h3>Going to display info here.</h3>
            <div class="wrapper">
...
<script>
    ...
    // liTag.innerHTML = "Appended List Item";
    //
    // objItems.appendChild(liTag);
